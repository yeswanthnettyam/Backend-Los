...
/**
 * Configuration entity for validation rules.
 * Defines business validation rules for screens.
 */
@Entity
@Table(name = "validation_configs", uniqueConstraints = {
...
public class ValidationConfig {
    ...
    @Column(name = "validation_rules", columnDefinition = "TEXT", nullable = false)

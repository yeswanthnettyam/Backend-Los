...
/**
 * Configuration entity for screen definitions.
 * Defines UI structure, fields, and actions for each screen.
 */
@Entity
@Table(name = "screen_configs", uniqueConstraints = {
...
public class ScreenConfig {
    ...
    @Column(name = "ui_config", columnDefinition = "TEXT", nullable = false)
